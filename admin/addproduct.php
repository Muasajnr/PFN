                                    ...
                                    <form class="needs-validation" novalidate accept-charset="utf-8">
                                        <div class="row g-2">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="currency" class="form-control" name="price" placeholder="Price" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="description" placeholder="Product Description" required style="height: 100px;">                                            <div class="valid-feedback">Looks good!</div>
                                            <div class="invalid-feedback">Please enter product description.</div>
                                        </div>
                                        <div class="row g-2">
                                            <div class="mb-3 col-md-6">
                                                <label for="Images" class="form-label">Images</label>
                                                <input type="file" class="form-control" name="images" placeholder="Attach Images" required>
                                                <div class="valid-feedback">Looks good!</div>
